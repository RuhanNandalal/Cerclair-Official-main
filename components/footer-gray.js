        ...
        <div className="footer-gray-container1">
          <div className="footer-gray-container2">
            <div className="footer-gray-container3">
              <span className="footer-gray-text10">Soft UI Design System</span>
            ...
            <div className="footer-gray-container5">
              <div className="footer-gray-container6">
                <span className="footer-gray-text12 Large">Company</span>
                <span className="footer-gray-text13 Large">About Us</span>
                <span className="footer-gray-text14 Large">Freebies</span>
                <span className="footer-gray-text15 Large">Premium Tools</span>
                <span className="footer-gray-text16 Large">Blog</span>
              </div>
              <div className="footer-gray-container7">
                <span className="footer-gray-text17 Large">Resources</span>
                <span className="footer-gray-text18 Large">Login</span>
                <span className="footer-gray-text19 Large">Register</span>
                <span className="footer-gray-text20 Large">About</span>
              </div>
              <div className="footer-gray-container8">
                <span className="footer-gray-text21 Large">
                  Help &amp; Support
                </span>
                <span className="footer-gray-text22 Large">Contact Us</span>
                <span className="footer-gray-text23 Large">
                  Knowledge Center
                </span>
                <span className="footer-gray-text24 Large">
                  Custom Development
                </span>
                <span className="footer-gray-text25 Large">Sponsorships</span>
              </div>
              <div className="footer-gray-container9">
                <span className="footer-gray-text26 Large">Legal</span>
                <span className="footer-gray-text27 Large">
                  Terms &amp; Conditions
                </span>
                <span className="footer-gray-text28 Large">Privacy Policy</span>
                <span className="footer-gray-text29 Large">
                  Licenses (EULA)
                </span>
              </div>
            </div>
          </div>
          <span className="footer-gray-text30 Small">
            <span>
            ...
            <span className="footer-gray-text32">Creative Tim</span>
            <span>.</span>
          </span>
        </div>
      </footer>
